$(document).ready(function(){
    ...
    $(".cmmntAjax").addComment({
                ...
                requiredKeys:["comment_time","comment"],
                dropLayerClass:"dropLayerCont",
                targetUrls:{"save":"j/newMsg.php","fetch":'j/fetchMsg.php',"method":"GET"},
                maxFetchCount:5,
                addBtn:"addMsg",                
                addMessageCallBack:function(){
                 console.log("messages added");
...
$(".cmmntRdOnly").addComment({
                ...
                requiredKeys:["comment_time","comment"],
                dropLayerClass:"dropLayerCont",
                targetUrls:{"save":"","fetch":'j/fetchMsg.php',"method":"GET"},
                maxFetchCount:5, 
                readonly:true,
                customScroll:true,
                prefilledData:prefilledData
...
$(".cmmntTupTpl").addComment({
                ...
                requiredKeys:["comment_time","comment"],
                dropLayerClass:"dropLayerCont",
                targetUrls:{"save":"j/newMsg.php","delete":"","fetch":'j/fetchMsg.php',"method":"GET"},
                maxFetchCount:5, 
                readonly:false,
                customScroll:true,
                prefilledData:prefilledData
